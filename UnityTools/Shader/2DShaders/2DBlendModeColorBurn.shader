Shader "UnityTools/2D Blend Mode/Color Burn"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float ColorBurn(float base, float top)
			{
				float output = 1.0 - (1.0 - base) / top;
				return output;
			}
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				col.r = ColorBurn(base.r, top.r);
				col.g = ColorBurn(base.g, top.g);
				col.b = ColorBurn(base.b, top.b);
				col.a = top.a;
