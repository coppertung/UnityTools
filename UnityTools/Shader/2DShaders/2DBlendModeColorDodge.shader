Shader "UnityTools/2D Blend Mode/Color Dodge"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float ColorDodge(float base, float top)
			{
				float output = base / (1.0 - top);
				return output;
			}
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				col.r = ColorDodge(base.r, top.r);
				col.g = ColorDodge(base.g, top.g);
				col.b = ColorDodge(base.b, top.b);
				col.a = top.a;
