Shader "UnityTools/2D Blend Mode/Linear Burn"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float LinearBurn(float base, float top)
			{
				float output = base + top - 1.0;
				return output;
			}
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				col.r = LinearBurn(base.r, top.r);
				col.g = LinearBurn(base.g, top.g);
				col.b = LinearBurn(base.b, top.b);
				col.a = top.a;
