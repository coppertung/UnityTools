Shader "UnityTools/2D Blend Mode/Lighten"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float Lighten(float base, float top)
			{
				float output = max(base, top);
				return output;
			}
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				col.r = Lighten(base.r, top.r);
				col.g = Lighten(base.g, top.g);
				col.b = Lighten(base.b, top.b);
				col.a = top.a;
